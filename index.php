                ...
                <div class="sl-slider">
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            ...
                            <div class="carousel-caption">
                                <div>
                                    <img class="wow fadeInUp" src="img/St21_logo2.png" alt="St 21">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                        <div class="sl-slide-inner">
                            ...
                            <div class="carousel-caption">
                                <div>
                                    <h2 class="heading animated fadeInDown">Especialistas en telefonía móvil</h2>
                                    <h3 class="animated fadeInUp">Reparamos y liberamos equipos para todas las operadoras</h3>
                                    <a class="btn btn-green animated fadeInUp" href="#about">Ver más</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            ...
                            <div class="carousel-caption">
                                <div>
                                    <h2 class="heading animated fadeInRight">La mayor rapidez en reparación de teléfonos</h2>
                                    <h3 class="animated fadeInLeft">Porque valoramos tu tiempo</h3>
                                    <a class="btn btn-green animated fadeInUp" href="#blog">Ver más</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="title text-center wow fadeIn" data-wow-duration="1500ms" >
                        <h2>Conoce<span class="color">nos</span></h2>
                    ...
                    <div class="col-md-4 text-center wow fadeInUp" data-wow-duration="500ms" >
                        <div class="wrap-about">							
                            ...
                            <div class="about-content text-center">
                                <h3 class="ddd">Lorem ipsum dolor</h3>								
